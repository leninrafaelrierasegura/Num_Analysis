...
- $(P_r +\tau C^{-1}P_l)U^{k+1} = P_r U^{k}$ works the best so far.

- Using either $C^{-1}$ or $\tilde{C}^{-1}$ makes no difference. Here $\tilde{C}$ is the mass lumped version of $C$.

- Things go well as long as $0.5<\alpha$.
